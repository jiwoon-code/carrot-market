      ...
      <div className="space-y-4 px-4">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div key={i} className="cursor-pointer flex flex-col items-start">
            ...
            <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-b-[2px] w-full">
        ...
        <button className="fixed hover:bg-orange-600 cursor-pointer transition-colors bottom-24 right-5 bg-orange-500 shadow-md rounded-full p-4 text-white">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
